# Contributing to LlamaLaw

Thank you for your interest in contributing to LlamaLaw! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaLaw:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamalaw.git
   cd llamalaw
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamalaw.git
   ```
...
By contributing to LlamaLaw, you agree that your contributions will be licensed under the project's MIT License.
